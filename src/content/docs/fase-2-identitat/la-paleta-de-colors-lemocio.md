...
Adobe Color permet generar paletes de colors personalitzades seguint diferents regles cromàtiques. Pots seleccionar un color base i generar una combinació segons criteris harmònics. Aquí tens les 3 més importants per al vostre projecte:
- Anàlegs: Són colors que estan un al costat de l'altre al cercle cromàtic (ex: blau, turquesa i verd). Efecte: Transmeten pau, harmonia i natura. Ideal per a joies que s'inspiren en el mar o el bosc.
- Complementaris: Són colors que estan just al davant (ex: taronja i blau). Efecte: Són colors que "xoquen" i criden molt l'atenció. Ideal per a una marca jove, rebel o molt moderna.
...
- Color de primer pla (Foreground): El color de les teves lletres o logotip.
- Color de fons (Background): El color de la teva targeta, caixa o web.
