...
- **Passió:** Quina és aquella cosa (un hobby, una música, una passió) que, quan la fas, fa que el temps passi volant i t'oblidis de tot? Com podries transformar aquesta passió en un objecte?
...
- **HARMONIA - Limita els colors:** Selecciona només 3 o 4 colors principals i assegura't que apareguin a gairebé totes les imatges. Si tot té colors diferents, es veurà desordenat.
